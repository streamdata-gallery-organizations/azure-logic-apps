...
paths:
  ...
  : get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftlogicintegrationaccountsintegrationaccountnamesessions-get
      parameters:
      - in: query
        name: $filter
        description: The filter to apply on the operation
  ...
  : get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftlogicintegrationaccountsintegrationaccountnamesessionssessionname-get
      parameters:
      - in: path
        name: integrationAccountName
        description: The integration account name
    ...
    put:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftlogicintegrationaccountsintegrationaccountnamesessionssessionname-put
      parameters:
      - in: path
        name: integrationAccountName
        description: The integration account name
    ...
    delete:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftlogicintegrationaccountsintegrationaccountnamesessionssessionname-delete
      parameters:
      - in: path
        name: integrationAccountName
        description: The integration account name
  ...
  /providers/Microsoft.Logic/operations:
    get:
      ...
      x-api-path-slug: providersmicrosoftlogicoperations-get
      parameters:
      - in: query
        name: No Name
      responses:
